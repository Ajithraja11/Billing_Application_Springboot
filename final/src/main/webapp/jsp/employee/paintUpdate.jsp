...
<body>
	...
	<h1>Paint old bill update Section</h1>
	<br>
	<div class="container">
		<div class="row">
			<div class="col-sm-8 ">
				<form:form action="/employee/PaintUpdateForm" modelAttribute="paint">

					<div class="labels">Name of the customer(*):</div>
					<div class="input">
						<form:input path="customer_name" value="${paint.customer_Name}" />
					...
					<div class="input">
						<form:input path="size30ml" value="${paint.size30ml}" />
					...
					<div class="input">
						<form:input path="size100ml" value="${paint.size1000ml}" />
					...
					<div class="input">
						<form:input path="size500ml" value="${paint.size500ml}" />
					...
					<div class="input">
						<form:input path="size1l" value="${paint.size1l}" />
