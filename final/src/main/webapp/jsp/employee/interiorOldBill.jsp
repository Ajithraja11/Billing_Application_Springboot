			...
			<div class="row">
				<div class="span12">
					<c:if test="${show==1}">
						<fieldset>
							<legend>
								Enter <strong>Receipt</strong> of the old Interior bill to
								display-<a href="/employee/interior">Back</a>
							</legend>
						</fieldset>

						<form:form action="getInteriorBill" modelAttribute="receipt">
							<p class="text-center">
					...
					<c:if test="${show==0}">
						<fieldset>
							<legend>
								...
								update-<a href="/employee/interior">Back</a>
							</legend>
						</fieldset>
