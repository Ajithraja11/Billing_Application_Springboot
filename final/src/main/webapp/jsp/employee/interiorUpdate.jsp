...
<body>
	...
	<hr class="new4">
	<h1>Interior Materials Update Section</h1>
	<br>
	<div class="container">
		<div class="row">
			<div class="col-sm-8 ">
				<form:form action="/employee/InteriorUpdateForm"
					modelAttribute="interior">

					<div class="labels">Name of the customer(*):</div>
					<div class="input">
						<form:input path="customer_name"
							value="${interior.customer_name }" />
					...
					<div class="input">
						<form:input path="numberOfDoor" value="${interior.numberOfDoor }" />
					...
					<div class="input">
						<form:input path="numberOfFan" value="${interior.numberOfFan }" />
					...
					<div class="input">
						<form:input path="numberOfLight"
							value="${interior.numberOfLight }" />
					...
					<div class="input">
						<form:input path="numberOfMarbel"
							value="${interior.numberOfMarbel }" />
