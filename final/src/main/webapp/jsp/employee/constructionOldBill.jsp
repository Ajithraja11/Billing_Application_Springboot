			...
			<div class="span12">
				...
				<c:if test="${show==1}">
					<fieldset>
						<legend>
							...
							display-<a href="/employee/construction">Back</a>
						</legend>
					</fieldset>
					<form:form action="getConstructionBill" modelAttribute="receipt">
						<p class="text-center">
				...
				<c:if test="${show==0}">
					<fieldset>
						<legend>
							Enter <strong>Receipt</strong> of the old customer bill to
							update-<a href="/employee/construction">Back</a>
						</legend>
					</fieldset>
					<form:form action="getUpdateConstructionBill"
