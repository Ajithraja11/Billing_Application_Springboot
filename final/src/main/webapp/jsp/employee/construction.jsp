...
<body>
	...
	<h3>Construction Materials Billing Section</h3>
	<br>

	<div class="container">
		<div class="row">
			<div class="col-sm-8 ">
				<form:form action="/employee/processForm"
					modelAttribute="construction">
					...
					<div class="input">
						<form:input path="sand_unit" value="0"></form:input>
					...
					<div class="input">
						<form:input path="bricks_6" value="0" />
					...
					<div class="input">
						<form:input path="bricks_10" value="0" />
					...
					<div class="input">
						<form:input path="cementBag" value="0" />
